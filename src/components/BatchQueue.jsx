  ...
  return (
        <div style={{ marginTop: '8px' }}>
                <button
                        ...
                        >
                  {expanded ? '▲' : '▼'} {expanded ? 'Hide detail' : 'View compliance detail'}
                </button>button>
...
export default function BatchQueue() {
    ...
    return (
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                <div className="card">
                        <div className="card-title">Batch Verification</div>div>
                        ...
                        <div
                                  ...
                                  <p>Drop label images here or click to browse</p>p>
                                  <span>Select multiple files — up to 50 labels per batch</span>span>
                        </div>div>
                                                                              ...
                                                                              <div style={{ flexShrink: 0 }}>
                                                                                {item.status === 'processing' ? (
                                                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                                                                                              ...
                                                                                                              <span style={{ fontSize: '11px', color: 'var(--copper)' }}>Checking...</span>span>
                                                                                      </div>div>
                                                                                  ) : item.status === 'pass' ? (
                                                                                    <span style={{
                                                                                                                fontSize: '11px',
                                  ...
                                  <div style={{ display: 'flex', gap: '10px', marginTop: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
                                    {pendingCount > 0 && (
                                        <button
                                                            ...
                                                            disabled={running}
                                                          >
                                          {running ? 'Verifying...' : `Verify ${pendingCount} Label${pendingCount !== 1 ? 's' : ''}`}
                                        </button>button>
                                                )}
                                    {hasResults && (
                                        <button className="btn-export" onClick={exportCSV}>Export CSV</button>button>
                                                )}
                                    {!running && items.length > 0 && (
                                        <button className="btn-export" onClick={clearAll}>Clear All</button>button>
                                                )}
                                  </div>div>
                      </>>
                    )}
